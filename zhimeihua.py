...
def main():
    ...
    for i in range(3):
        ...
        time.sleep(random.randint(3, 6))
        browser.find_element(by=By.XPATH, value='//div["respond"]/div[2]/div[3]/textarea[@id="textarea"]').click()
        time.sleep(random.randint(3, 6))
        browser.find_element(by=By.XPATH, value='//div["respond"]/div[2]/div[3]/textarea[@id="textarea"]').send_keys(random.choice(comments))
        time.sleep(random.randint(3, 6))
        browser.find_element(by=By.XPATH, value='//*[@id="respond"]/div[2]/div[4]/div[2]/button[2]').click()
        time.sleep(random.randint(3, 6))
